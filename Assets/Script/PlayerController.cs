            ...
            if (canMove && !LevelManager.instance.isPaused)
            {
                ...
                if (Input.GetKeyDown(KeyCode.Alpha1) || shouldUsePosionSpell)
                {
                    if (spellCounter <= 0)
                    {
                        ...
                        PhotonNetwork.Instantiate(poisonSpell.name, theCam.ScreenToWorldPoint(Input.mousePosition) + new Vector3(0f, 0f, 10f), transform.rotation);
                       /* //Moblie
                        targetEnemy = FindTarget(enemies);
                        if (targetEnemy)
                ...
                if (Input.GetKeyDown(KeyCode.Alpha2) || shouldUseIceSpell)
                {
                    if (spellCounter <= 0)
                    {
                        ...
                        AudioManager.instance.PlaySFX(21);
                        PhotonNetwork.Instantiate(iceSpell.name, theCam.ScreenToWorldPoint(Input.mousePosition) + new Vector3(0f, 0f, 10f), transform.rotation);//PC
                        //Moblie
                        /*targetEnemy = FindTarget(enemies);
                        if (targetEnemy)
                ...
                if (Input.GetKeyDown(KeyCode.Alpha3) || shouldUseBoonSpell)
                {
                    if (spellCounter <= 0)
                    {
                        ...
                        PhotonNetwork.Instantiate(boom.name, theCam.ScreenToWorldPoint(Input.mousePosition) + new Vector3(0f, 0f, 10f), transform.rotation);
                        //Moblie
                       /* targetEnemy = FindTarget(enemies);
                        if (targetEnemy)
